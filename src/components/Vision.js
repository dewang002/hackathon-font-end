...
function Vision() {
  ...
  return (
    <>
      ...
      <div className="vision h-[90.4vh] w-[72vw] mx-auto  flex flex-col items-center">
        ...
        <div className="contentBox h-full w-full text-center text-zinc-200">
          ...
          <div className="context h-[60vh] ml-[15%] w-[70%] ">
            ...
            We strive to develop AI-driven solutions that not only
                solve complex business problems but also cultivate a deeper understanding of the data
                that shapes our world.
                We envision a future where every organization, regardless of its size or sector, has
                access to the power of advanced data analytics, enabling them to make smarter
                decisions, innovate faster, and drive meaningful progress. Our goal is to become the
                cornerstone for transformative analytics that empower businesses to lead with
